...
{
    var fromAddress = new MailAddress("arijkrir5@gmail.com", "Your E-Commerce Site");
    var toAddress = new MailAddress(user.Email, $"{user.Nom} {user.Prenom}");
    var fromPassword = "your_application_password"; // Utilisez un mot de passe d'application si nécessaire

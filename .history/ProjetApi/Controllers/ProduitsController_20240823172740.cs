...
public async Task<ActionResult<IEnumerable<object>>> GetCrossSellingProducts([FromQuery] int productId)
{
    ...
    // Vérifier et corriger le chemin de l'image du produit sélectionné
    ...
    // Log: Afficher l'image du produit sélectionné avec le chemin corrigé
    Console.WriteLine($"Produit sélectionné: {selectedProduct.Designation}, Image: {imagePath}");

    // Définir les groupes d'images pour le cross-selling
    var imageGroups = new List<List<string>>
    {
        new List<string> { "/images/61gKkYQn6lL._AC_SL1500_.jpg", "/images/81TI60TumXS._AC_SL1500_.jpg", "/images/61Yupm5970L._AC_SL1200_.jpg", "/images/61YQeAUIboL._AC_SL1500_.jpg", "/images/817Da7pNmfL._AC_SY695_.jpg", "/images/71QN5UjfFRL._AC_SL1500_.jpg" },
        new List<string> { "/images/51N2hUP7+pL._SL1500_.jpg", "/images/61UGUXvwnnL._SL1500_.jpg", "/images/51bn3oFzysL._SL1500_.jpg", "/images/61KedtnoewL._SL1500_.jpg", "/images/71MQo8pHmBL._SL1500_.jpg", "/images/81ckNCi05KL._SL1500_.jpg", "/images/71dzwr2VOzL._SL1500_.jpg", "/images/71cQa9CUS0L._SL1420_.jpg", "/images/810R6LO0ZeL._SL1500_.jpg" },
        new List<string> { "/images/61Di8duRsJL._SL1200_.jpg", "/images/61IW-8gE8CL._AC_SL1000_.jpg", "/images/71NEfdX5eSL._SL1500_.jpg", "/images/61wd3vtedaL._SL1500_.jpg", "/images/513LvDOMTBL._AC_SL1500_.jpg", "/images/613lBPFv93L._SL1500_.jpg" },
        new List<string> { "/images/71XR3lo00cL._AC_SL1500_.jpg", "/images/617z6N3l59L._AC_SL1500_.jpg", "/images/716YUdHaK0L._AC_SL1500_.jpg", "/images/91ZNEt0wTML._AC_SL1500_.jpg", "/images/81A6emwYQGL._AC_SL1500_.jpg", "/images/71+8uTMDRFL._AC_SL1500_.jpg", "/images/71+8ct7NbAL._AC_SL1500_.jpg" }
    };
    ...
    // Récupérer les produits en utilisant une requête paginée pour éviter la surcharge mémoire
    var pageSize = 100; // Ajuster selon vos besoins
    var allProductsQuery = _context.Produits.AsQueryable();

    // Trouver le groupe d'images auquel appartient le produit sélectionné
    List<string> selectedGroup = null;
    foreach (var group in imageGroups)
    {
        // Log: Afficher le groupe en cours de vérification
        Console.WriteLine($"Vérification du groupe: {string.Join(", ", group)}");

        if (group.Contains(imagePath))
        {
            selectedGroup = group;
            break;
        }
    ...
    {
        return NotFound("Aucun groupe d'images correspondant trouvé");
    }

    // Appliquer le filtrage
    var crossSellingProducts = await allProductsQuery
        .Where(p => selectedGroup.Contains("/images/" + p.Image) && p.Id != productId)
        .Join(csvProducts, p => p.Id, csv => csv.Id, (p, csv) => new 
        {
            p.Id,
            p.Designation,
            csv.PromoPrice,
    ...
    if (crossSellingProducts.Count == 0)
    {
        return NotFound("Aucun produit cross-selling trouvé");
    }

    return Ok(crossSellingProducts);
}

...
public async Task<ActionResult<IEnumerable<object>>> GetCrossSellingProducts([FromQuery] int productId)
{
    ...
    // Log: Afficher l'image du produit sélectionné
    Console.WriteLine($"Produit sélectionné: {selectedProduct.Designation}, Image: /images/{selectedProduct.Image}");

    // Définir les groupes d'images pour le cross-selling avec le préfixe /images/
    ...
    foreach (var group in imageGroups)
    {
        ...
        if (group.Contains("/images/" + selectedProduct.Image))
        {
            selectedGroup = group;
            break;
        }

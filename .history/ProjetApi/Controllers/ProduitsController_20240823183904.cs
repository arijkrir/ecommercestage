...
{
    // Groupes d'images définis localement dans la méthode
    var imageGroups = new Dictionary<int, List<string>>
    {
        { 1, new List<string> { "/images/61gKkYQn6lL._AC_SL1500_.jpg", "/images/81TI60TumXS._AC_SL1500_.jpg", "/images/61Yupm5970L._AC_SL1200_.jpg", "/images/61YQeAUIboL._AC_SL1500_.jpg", "/images/817Da7pNmfL._AC_SY695_.jpg", "/images/71QN5UjfFRL._AC_SL1500_.jpg" } },
        { 2, new List<string> { "/images/51N2hUP7+pL._SL1500_.jpg", "/images/61UGUXvwnnL._SL1500_.jpg", "/images/51bn3oFzysL._SL1500_.jpg", "/images/61KedtnoewL._SL1500_.jpg", "/images/71MQo8pHmBL._SL1500_.jpg", "/images/81ckNCi05KL._SL1500_.jpg", "/images/71dzwr2VOzL._SL1500_.jpg", "/images/71cQa9CUS0L._SL1420_.jpg", "/images/810R6LO0ZeL._SL1500_.jpg" } },
        { 3, new List<string> { "/images/61Di8duRsJL._SL1200_.jpg", "/images/61IW-8gE8CL._AC_SL1000_.jpg", "/images/71NEfdX5eSL._SL1500_.jpg", "/images/61wd3vtedaL._AC_SL1500_.jpg", "/images/513LvDOMTBL._AC_SL1500_.jpg", "/images/613lBPFv93L._SL1500_.jpg" } },
        { 4, new List<string> { "/images/71XR3lo00cL._AC_SL1500_.jpg", "/images/617z6N3l59L._AC_SL1500_.jpg", "/images/716YUdHaK0L._AC_SL1500_.jpg", "/images/91ZNEt0wTML._AC_SL1500_.jpg", "/images/81A6emwYQGL._AC_SL1500_.jpg", "/images/71+8uTMDRFL._AC_SL1500_.jpg", "/images/71+8ct7NbAL._AC_SL1500_.jpg" } }
    };

    // Récupérer le produit sélectionné depuis la base de données
    var selectedProduct = await _context.Produits.FindAsync(productId);
    if (selectedProduct == null)
    {
        return NotFound("Produit non trouvé");
    ...
    var selectedImage = selectedProduct.Image;
    var imageGroupId = imageGroups.FirstOrDefault(g => g.Value.Contains(selectedImage)).Key;

    if (imageGroupId == 0)
    {
        return NotFound("Groupe d'images non trouvé");
    }

    var groupImageList = imageGroups[imageGroupId];

    // Récupérer les produits du même groupe depuis la base de données
    var crossSellingProductsFromDb = await _context.Produits
        .Where(p => groupImageList.Contains(p.Image) && p.Id != productId)
        .ToListAsync();
    ...
    // Joindre avec les données CSV pour obtenir les prix
    var crossSellingProducts = crossSellingProductsFromDb
        .Join(csvProducts, 
              p => p.Id, 
              csv => csv.Id, 
              (p, csv) => new { Produit = p, Csv = csv })
        ...
        .Take(5) // Limiter le nombre de résultats pour éviter une surcharge de mémoire
        .ToList();

    if (crossSellingProducts.Count == 0)
    {
        return NotFound("Aucun produit de cross-selling trouvé");
    }

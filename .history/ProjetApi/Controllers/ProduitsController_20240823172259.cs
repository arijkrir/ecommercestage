...
public async Task<ActionResult<IEnumerable<object>>> GetCrossSellingProducts([FromQuery] int productId)
{
    ...
    // Récupérer tous les produits en mémoire
    var allProducts = await _context.Produits.ToListAsync();
    ...
    // Filtrer les produits en mémoire pour trouver les produits cross-selling
    var crossSellingProducts = allProducts

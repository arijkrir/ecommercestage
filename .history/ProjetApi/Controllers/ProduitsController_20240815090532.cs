...
{
    var products = await _context.Produits.ToListAsync(); // Récupère tous les produits

    foreach (var product in products)
    {
        // Déterminez la catégorie en fonction du nom de l'image
        string imageFileName = Path.GetFileName(product.Image); // Récupère le nom du fichier image
        string category = DetermineCategory(imageFileName);

        // Mettez à jour la catégorie dans l'objet produit
        product.Categorie = category;

        // Mettez à jour l'entité dans le contexte EF Core
    ...
    return Ok("Catégories mises à jour avec succès pour tous les produits.");
}

// Méthode pour déterminer la catégorie en fonction du nom de l'image
private string DetermineCategory(string imageFileName)
{
    // Correspondances des noms de fichiers aux catégories
    Dictionary<string, string> categoryMappings = new Dictionary<string, string>
    {
        {"61gKkYQn6lL._AC_SL1500_.jpg", "Electroniques"},
        {"61IfJQTeRuL._AC_SL1500_.jpg", "Electroniques"},
        {"61IW-8gE8CL._AC_SL1000_.jpg", "Electroniques"},
        {"61jYs6d0aUL._AC_SL1500_.jpg", "Electroniques"},
        {"61-K2lXmHQL._AC_SL1500_.jpg", "Electroniques"},
        {"61YQeAUIboL._AC_SL1500_.jpg", "Electroniques"},
        {"61Yupm5970L._AC_SL1200_.jpg", "Electroniques"},
        {"71LCmvrndjL._AC_SL1500_.jpg", "Electroniques"},
        {"71QN5UjfFRL._AC_SL1500_.jpg", "Electroniques"},
        {"81TI60TumXS._AC_SL1500_.jpg", "Electroniques"},
        {"715o6bJfYmL._AC_SL1500_.jpg", "Electroniques"},
        {"817Da7pNmfL._AC_SY695_.jpg", "Electroniques"},
        {"apple-tv-4k-hero-select-202210_FMT_WHH.jpg", "Electroniques"},
        {"HD_Smart_Small_Projector.jpg", "Electroniques"},
        {"HkNQ4KtZvS6AFbGfXSns3V-1200-80.jpg", "Electroniques"},
        {"61wd3vtedaL._SL1500_.jpg", "Électroménagers"},
        {"61Di8duRsJL._SL1200_.jpg", "Électroménagers"},
        {"71+8uTMDRFL._AC_SL1500_.jpg", "Électroménagers"},
        {"71NEfdX5eSL._SL1500_.jpg", "Électroménagers"},
        {"71UwRqtlo7L._AC_SL1500_.jpg", "Électroménagers"},
        {"81A6emwYQGL._AC_SL1500_.jpg", "Électroménagers"},
        {"513LvDOMTBL._AC_SL1500_.jpg", "Électroménagers"},
        {"613lBPFv93L._SL1500_.jpg", "Électroménagers"},
        {"51bn3oFzysL._SL1500_.jpg", "Beauty"},
        {"51N2hUP7+pL._SL1500_.jpg", "Beauty"},
        {"61-H2fFdM1L._SL1500_.jpg", "Beauty"},
        {"61K6cQhw4EL._SL1500_.jpg", "Beauty"},
        {"61KedtnoewL._SL1500_.jpg", "Beauty"},
        {"61UGUXvwnnL._SL1500_.jpg", "Beauty"},
        {"71cQa9CUS0L._SL1420_.jpg", "Beauty"},
        {"71dzwr2VOzL._SL1500_.jpg", "Beauty"},
        {"71iJfJSDcQL._SL1500_.jpg", "Beauty"},
        {"71MQo8pHmBL._SL1500_.jpg", "Beauty"},
        {"81ckNCi05KL._SL1500_.jpg", "Beauty"},
        {"810R6LO0ZeL._SL1500_.jpg", "Beauty"},
        {"71+8ct7NbAL._AC_SL1500_.jpg", "Cuisine"},
        {"71XR3lo00cL._AC_SL1500_.jpg", "Cuisine"},
        {"71+8uTMDRFL._AC_SL1500_.jpg", "Cuisine"},
        {"81A6emwYQGL._AC_SL1500_.jpg", "Cuisine"},
        {"91ZNEt0wTML._AC_SL1500_.jpg", "Cuisine"},
        {"617z6N3l59L._AC_SL1500_.jpg", "Cuisine"},
        {"716YUdHaK0L._AC_SL1500_.jpg", "Cuisine"}
    };

    // Recherche le nom de l'image dans le dictionnaire des correspondances
    if (categoryMappings.TryGetValue(imageFileName, out string category))
    {
        return category;
    }
    else
    {
        // Si aucune correspondance n'est trouvée, retourne une catégorie par défaut
        return "Autre";
    }
}

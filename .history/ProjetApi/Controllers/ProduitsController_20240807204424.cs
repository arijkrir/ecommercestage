...
public async Task<IActionResult> ConfirmOrder([FromBody] OrderRequest orderRequest)
{
    ...
    foreach (var articleRequest in orderRequest.Articles)
    {
        var article = new Article
        {
            ProduitId = articleRequest.ProduitId, // Assuming these fields match your Article model
            QuantiteeCommandee = articleRequest.QuantiteeCommandee,

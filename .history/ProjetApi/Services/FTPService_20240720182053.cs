...
public async Task<IActionResult> UpdateProductQuantitiesFromCsv()
{
    try
    {
        var ftpHost = "ftp://example.com"; // Remplacez par votre hôte FTP
        var ftpUsername = "username"; // Remplacez par votre nom d'utilisateur FTP
        var ftpPassword = "password"; // Remplacez par votre mot de passe FTP
        var remoteFilePath = "/path/to/products.csv"; // Chemin du fichier sur le serveur FTP

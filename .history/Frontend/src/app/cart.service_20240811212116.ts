...
export class CartService {
  ...
  clearCart(): void {
    console.log('Vider le panier');  // Ajoutez un log ici pour vérifier l'appel
    localStorage.removeItem('cartItems');  // Supprimez les articles du localStorage
    this.cartItemsSubject.next([]);  // Mettez à jour le BehaviorSubject
  }

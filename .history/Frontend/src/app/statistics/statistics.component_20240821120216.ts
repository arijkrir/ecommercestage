...
export class StatisticsComponent implements OnInit {
  ...
  chartOptions: any;
  topCategories = [
    { category: 'Electroniques', totalVentes: 78 },
    { category: 'Cuisine', totalVentes: 52 },
    { category: 'Beauty', totalVentes: 42 },
    { category: 'Électroménagers', totalVentes: 7 },
    { category: 'Non catégorisé', totalVentes: 3 }
  ];

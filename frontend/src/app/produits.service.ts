...
export class ProductService {
  ...
  getUpsellingProducts(productId: number): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/GetUpsellingProducts?productId=${productId}`);
  }

  GetCrossSellingProducts(productId: number): Observable<any[]> {
    return this.http.get<any[]>(`${this.apiUrl}/GetCrossSellingProducts?productId=${productId}`);
  }
